        ...
        case 'aws':
          return [
            ...
            },
            {
              ...
              description: 'AWS的中央连接点，用于连接VPC和本地网络',
              properties: [
                {
                  name: '描述',
                  key: 'description',
                  type: 'string',
                  defaultValue: 'Transit Gateway for multi-cloud connectivity',
                  placeholder: '请输入描述',
                  description: 'Transit Gateway的描述信息'
                },
                {
                  name: '自动接受共享附件',
                  ...
                  placeholder: '请输入enable或disable',
                  description: '是否自动接受共享附件，可选值为enable或disable'
                },
                {
                  name: 'DNS支持',
                  key: 'dns_support',
                  ...
                  defaultValue: 'enable',
                  placeholder: '请输入enable或disable',
                  description: '是否启用DNS支持，可选值为enable或disable'
                },
                {
                  name: 'VPN ECMP支持',
                  key: 'vpn_ecmp_support',
                  type: 'string',
                  defaultValue: 'enable',
                  placeholder: '请输入enable或disable',
                  description: '是否启用VPN ECMP支持，可选值为enable或disable'
                }
              ]
            }
          ];
